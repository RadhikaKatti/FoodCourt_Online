<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer_Master_Page.Master" AutoEventWireup="true" CodeBehind="Change_Password.aspx.cs" Inherits="Food_Court_Application.Customer.Change_Password" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-1 form-group">
            <asp:Label Font-Bold="true" ID="Label1" runat="server" Text="User Id"></asp:Label>
        </div>
    ...
    <div class="row">
     ...
     <div class="row">
        ...
        <div class="col-md-3 form-group">
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtnewpwd" ControlToValidate="txtconfirmpwd" ErrorMessage="Confirm Password"></asp:CompareValidator>
        </div>
        <div class="col-md-4"></div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4 form-group text-center">
            <asp:Button ID="btnchangepwd" OnClick="btnchangepwd_Click" runat="server" CssClass="btn btn-success" Text="Submit" />
        </div>
        <div class="col-md-4"></div>
    </div>
</asp:Content>
