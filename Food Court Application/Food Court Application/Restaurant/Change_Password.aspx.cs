...
namespace Food_Court_Application.Restaurant
{
    public partial class Change_Password : System.Web.UI.Page
    {
        ...
        {
            txtrestaurantid.Text = Session["Email"].ToString();
        }
        ...
        protected void btn_changepwd_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("update tbl_Restaurants_Details set Password='" + txtnewpwd.Text + "' where Email='" + txtrestaurantid.Text + "'", Db_Connection);
